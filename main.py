...
class Processor():
    ...
    def load_data(self):
        ...
        if self.arg.phase == 'train':
            ...
            print('train dataloader:', len(self.data_loader['train']), '\n')
        self.data_loader['test'] = torch.utils.data.DataLoader(
            ...
            drop_last=False,
            worker_init_fn=init_seed)
        print('test dataloader:', len(self.data_loader['test']))
        print('\n\n')
    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            if 'train_record.txt' in os.listdir():
                print('\n\n')
                s = str2bool(input('Remove train_record.txt? [y/n]:'))
                if s:
                    os.remove('train_record.txt')
                    print('train_record.txt is removed!')
                print('\n\n')
            ...
            print('self.arg.test_feeder_args[\'debug\']', self.arg.test_feeder_args['debug'])
